...
import { Users, Ticket, Clock, CheckCircle, AlertTriangle, Plus, Search, MessageSquare, User, ArrowRight, Eye, Play, CheckSquare, BarChart3, Zap, BookOpen, Settings, Brain } from 'lucide-react';
